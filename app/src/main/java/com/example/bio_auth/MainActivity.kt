...
import com.biometricauth.BiometricAuthentication
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setOnClickEvent() {
        ...
        biometricAuthBTN.setOnClickListener {
            if (BiometricAuthentication.isBiometricSupported(this)) {

                BiometricAuthentication.showBiometricPrompt(this@MainActivity)
            }
        }
